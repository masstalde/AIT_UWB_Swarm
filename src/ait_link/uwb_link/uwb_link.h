...
//
//    void setMeasurementsFromRawResult(UWB2WayMultiRange<NUM_OF_DW_UNITS>::RawRangingResult& raw_result){
//
//    	setSlaveMeasurement(raw_result.timestamp_master_request_1_recv, timestamp_slave_reply_send, timestamp_master_request_2_recv);
//
//    	for(int i = 0; i < NUM_OF_DW_UNITS; i++)
//    		addModuleMeasurement(raw_result.timestamp_master_request_1[i], raw_result.timestamp_slave_reply[i], raw_result.timestamp_master_request_2[i]);
//
//    }
