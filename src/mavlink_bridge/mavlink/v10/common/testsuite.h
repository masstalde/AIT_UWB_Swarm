...
static void mavlink_test_set_control_target_local_ned(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_set_control_target_local_ned_t packet_in = {
		17.0,45.0,73.0,101.0,53,120,187,254
    };
	mavlink_set_control_target_local_ned_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.x = packet_in.x;
        	packet1.y = packet_in.y;
        	packet1.z = packet_in.z;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_control_target_local_ned_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_set_control_target_local_ned_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_control_target_local_ned_pack(system_id, component_id, &msg , packet1.x , packet1.y , packet1.z , packet1.yaw , packet1.target_system , packet1.target_component , packet1.control_target , packet1.coordinate_frame );
	mavlink_msg_set_control_target_local_ned_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_control_target_local_ned_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.x , packet1.y , packet1.z , packet1.yaw , packet1.target_system , packet1.target_component , packet1.control_target , packet1.coordinate_frame );
	mavlink_msg_set_control_target_local_ned_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_set_control_target_local_ned_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_control_target_local_ned_send(MAVLINK_COMM_1 , packet1.x , packet1.y , packet1.z , packet1.yaw , packet1.target_system , packet1.target_component , packet1.control_target , packet1.coordinate_frame );
	mavlink_msg_set_control_target_local_ned_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_set_gimbal_reference_local_ned(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_set_gimbal_reference_local_ned_t packet_in = {
		17.0,45.0,73.0,41
    };
	mavlink_set_gimbal_reference_local_ned_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.roll = packet_in.roll;
        	packet1.pitch = packet_in.pitch;
        	packet1.yaw = packet_in.yaw;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_gimbal_reference_local_ned_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_set_gimbal_reference_local_ned_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_gimbal_reference_local_ned_pack(system_id, component_id, &msg , packet1.roll , packet1.pitch , packet1.yaw , packet1.gimbal_mode );
	mavlink_msg_set_gimbal_reference_local_ned_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_gimbal_reference_local_ned_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.roll , packet1.pitch , packet1.yaw , packet1.gimbal_mode );
	mavlink_msg_set_gimbal_reference_local_ned_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_set_gimbal_reference_local_ned_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_gimbal_reference_local_ned_send(MAVLINK_COMM_1 , packet1.roll , packet1.pitch , packet1.yaw , packet1.gimbal_mode );
	mavlink_msg_set_gimbal_reference_local_ned_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_set_control_target_local_ned(system_id, component_id, last_msg);
	mavlink_test_set_gimbal_reference_local_ned(system_id, component_id, last_msg);
